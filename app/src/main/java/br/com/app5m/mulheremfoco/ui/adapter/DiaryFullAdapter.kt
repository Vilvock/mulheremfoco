...
class DiaryFullAdapter (private val categoryList: List<CategorySubList>, val clickListener: RecyclerItemClickListener, context: Context):
    RecyclerView.Adapter<DiaryFullAdapter.CategoriesHoriHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoriesHoriHolder {
     /*   val displayMetrics = DisplayMetrics()
        ...
        return CategoriesHoriHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.adapter_full_diary, parent, false)
        )
    }
...
//        createCategories(categoryItem)
    ...
    fun configureCategoriesAdapter(
        ...
        categoriesAdapter = ChildDiaryAdapter(listCategorySubListItem, object : RecyclerItemClickListener {
...
*/
        ...
        val vmProduct = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
